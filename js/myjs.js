$(function() {
	...
	img.each(function(j) {
		var Nimg = new Image();
		Nimg.src = "img/110.gif";
		Nimg.onload = function() {
			Nimg.onload = null;
			n++;
			//			console.log(n);
			$(".loading b").html(parseInt(n / size * 100) + "%");
			if(n == size) {
				$(".loading").fadeOut();
			}
		}
...
$(".outer .btn").click(function() {
	...
	setTimeout(function() {
		...
		$('.outer_2').removeClass('animated zoomOut');
		$('.outer_2').addClass('animated zoomIn');
	}, 500);
...
$(".x").click(function() {
	...
	//	console.log($(".outer_2[swiper-animate-effect]"));
	//	$(".outer_2[swiper-animate-effect]").attr("swiper-animate-effect","zoomOut");
	$('.outer_2').removeClass('animated zoomIn').addClass('animated zoomOut');
	//	setTimeout(function () { 
